...
#define ICON_ORG           ICON_STR(FILE_TEX, "  ", ICON_DOCUMENT)
...
static const struct icon_pair icons_name[] = {
  ...
  {"Escritorio",     ICON_DESKTOP,   0},
  {"Documentos",   ICON_BRIEFCASE, 0},
	{"Descargas",   ICON_DOWNLOADS, 0},
  {"Música",       ICON_MUSIC,     0},
  {"Imágenes",    ICON_PICTURES,  0},
  {"Público",      ICON_PUBLIC,    0},
  {"Plantillas",   ICON_TEMPLATES, 0},
  {"Vídeos",      ICON_VIDEOS,    0},
...
static const struct icon_pair icons_ext[] = { /* All entries are case-insensitive */
	...
	{"rc",         ICON_CONFIGURE,      0},
	{"rom",        ICON_EXT_ROM,        0},
	{"rmd",        ICON_EXT_MD,         COLOR_DOCS},
	{"rmarkdown",  ICON_EXT_MD,         COLOR_DOCS},
